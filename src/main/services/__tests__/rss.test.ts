...
describe('RssService', () => {
  ...
  describe('fetchArticles', () => {
    ...
    it('should extract thumbnail from enclosure', async () => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const mockFeed: any = {
        title: 'Test Feed',
        items: [
    ...
    it('should extract thumbnail from content img tag', async () => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const mockFeed: any = {
        title: 'Test Feed',
        items: [
          {
            ...
            pubDate: '2024-01-15T10:00:00Z',
            description: 'Article',
            content: '<img src="https://example.com/content-image.jpg" alt="test" />'
          }
        ]
      }
      ...
      expect(articles[0].thumbnail).toBe('https://example.com/content-image.jpg')
    })

    it('should return null thumbnail when not found', async () => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const mockFeed: any = {
        title: 'Test Feed',
        items: [
      ...
      expect(articles[0].thumbnail).toBeNull()
    })
